...
run_model = 'leakgan'  # seqgan, leakgan, maligan, jsdgan, relgan, evogan, sentigan, catgan, dpgan, dgsan, cot
...
eval_type = 'bleu3'  # standard, rsgan, nll, nll-f1, Ra, bleu3, bleu-f1
...
train_data = '/notebooks/dataset/' + dataset + '.txt'
test_data = '/notebooks/dataset/testdata/' + dataset + '_test.txt'
cat_train_data = '/notebooks/dataset/' + dataset + '_cat{}.txt'
cat_test_data = '/notebooks/dataset/testdata/' + dataset + '_cat{}_test.txt'
...
save_root = '/notebooks/save/{}/{}/{}_{}_dt-{}_lt-{}_mt-{}_et-{}_sl{}_temp{}_lfd{}_T{}/'.format(time.strftime("%Y%m%d"),
...
oracle_state_dict_path = '/notebooks/pretrain/oracle_data/oracle_lstm.pt'
oracle_samples_path = '/notebooks/pretrain/oracle_data/oracle_lstm_samples_{}.pt'
multi_oracle_state_dict_path = '/notebooks/pretrain/oracle_data/oracle{}_lstm.pt'
multi_oracle_samples_path = '/notebooks/pretrain/oracle_data/oracle{}_lstm_samples_{}.pt'

pretrain_root = '/notebooks/pretrain/{}/'.format(dataset if if_real_data else 'oracle_data')
#pretrained_gen_path = pretrain_root + 'gen_MLE_pretrain_{}_{}_sl{}_sn{}.pt'.format(run_model, model_type, max_seq_len,samples_num)
pretrained_gen_path = pretrain_root + 'save/20220417/image_coco/leakgan_vanilla_dt-Ra_lt-rsgan_mt-ra_et-bleu3_sl37_temp1_lfd0.0_T0417_0540_37/models/gen_MLE_00007.pt'.format(run_model, model_type, max_seq_len, samples_num)
...
def init_param(opt):
    ...
    if max_seq_len == 40:
        oracle_samples_path = '/notebooks/pretrain/oracle_data/oracle_lstm_samples_{}_sl40.pt'
        multi_oracle_samples_path = '/notebooks/pretrain/oracle_data/oracle{}_lstm_samples_{}_sl40.pt'
